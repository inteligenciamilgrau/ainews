...
const researchLabs = [
  ...
  {
    id: "ar-sinci-unl-conicet",
    name: "sinc(i) - Instituto de Senales, Sistemas e Inteligencia Computacional",
    organization: "UNL / CONICET",
    category: "Instituto",
    city: "Santa Fe",
    region: "Santa Fe",
    country: "Argentina",
    address: "Ciudad Universitaria UNL, RN 168 km 472.4, FICH, 4th floor",
    lat: -31.6403,
    lng: -60.6736,
    focus: "Machine learning, data mining, signal processing, complex systems, autonomous systems and bioinformatics",
    notes: "Official UNL-CONICET research institute applying computational intelligence to health, precision agriculture, energy and human-machine interfaces. Marker uses its published FICH location.",
    sourceName: "sinc(i) - UNL / CONICET",
    sourceUrl: "https://sinc.unl.edu.ar/es/"
  },
  {
    id: "ar-lidesia-unc",
    name: "LIDeSIA - Laboratorio de Software e Inteligencia Artificial",
    organization: "FCEFyN / Universidad Nacional de Cordoba",
    category: "Universidade",
    city: "Cordoba",
    region: "Cordoba",
    country: "Argentina",
    address: "Av. Velez Sarsfield 1611, Ciudad Universitaria",
    lat: -31.4424,
    lng: -64.1934,
    focus: "Responsible AI adoption, software R&D, applied prototypes, education and technology transfer",
    notes: "Official UNC laboratory combining research, teaching and extension around socially responsible AI. Its page identifies the faculty; the marker uses the faculty's official campus address.",
    sourceName: "FCEFyN - UNC",
    sourceUrl: "https://fcefyn.unc.edu.ar/facultad/secretarias/investigacion-y-desarrollo/laboratorios/laboratorio-de-investigacion-y-desarrollo-de-software-e-inteligencia-artificial-lidesia/"
  },
  {
    id: "ar-licdia-unlu",
    name: "LICDIA - Laboratorio de Ciencia de Datos e Inteligencia Artificial",
    organization: "Universidad Nacional de Lujan",
    category: "Universidade",
    city: "Lujan",
    region: "Buenos Aires",
    country: "Argentina",
    address: "Ruta 5 y Av. Constitucion, Pabellon de Laboratorios de Informatica",
    lat: -34.57623,
    lng: -59.08909,
    focus: "Applied AI, LLMs, data science, environmental and biological data, population behavior",
    notes: "Official UNLu research laboratory developing AI and data-science solutions for real problems. The lab page places it in the computing-laboratories pavilion at the Lujan campus.",
    sourceName: "LICDIA - UNLu",
    sourceUrl: "https://licdia.unlu.edu.ar/"
  },
  {
    id: "bo-dtt-ucb-tarija",
    name: "DTT - Laboratorio de Desarrollo y Transferencia de Tecnologia",
    organization: "Universidad Catolica Boliviana San Pablo - Tarija",
    category: "Universidade",
    city: "Tarija",
    region: "Tarija",
    country: "Bolivia",
    address: "Calle Colon 734",
    lat: -21.53325,
    lng: -64.73127,
    focus: "Applied AI, machine learning, NLP, deep learning, cloud prototyping and technology transfer",
    notes: "Official UCB laboratory with a dedicated AI axis for training, applied projects and transfer to public and private partners. Marker uses the published central-campus address.",
    sourceName: "UCB Tarija",
    sourceUrl: "https://tja.ucb.edu.bo/dtt-laboratorio-de-desarrollo-y-transferencia-de-tecnologia/"
  },
  {
    id: "cl-inria-binational-ai",
    name: "Centro Binacional Franco-Chileno de Inteligencia Artificial",
    organization: "Inria Chile / Ministerio de Ciencia de Chile",
    category: "Consorcio",
    city: "Santiago",
    region: "Region Metropolitana",
    country: "Chile",
    address: "Av. Apoquindo 2827, piso 12, Las Condes",
    lat: -33.4167,
    lng: -70.601,
    focus: "Generative and foundation models, AI evaluation, AI for science, frugal AI, innovation and public policy",
    notes: "Official bilateral AI center created by Chile and France and operated by Inria Chile. The final projects are distributed; the marker uses the operator's official Santiago office.",
    sourceName: "Inria Chile",
    sourceUrl: "https://www.inria.cl/es/el-ministerio-de-ciencia-de-chile-e-inria-anuncian-la-creacion-de-un-centro-binacional-de"
  },
  {
    id: "cl-idia-uchile",
    name: "IDIA - Iniciativa de Datos e Inteligencia Artificial",
    organization: "FCFM / Universidad de Chile",
    category: "Universidade",
    city: "Santiago",
    region: "Region Metropolitana",
    country: "Chile",
    address: "Beauchef 851",
    lat: -33.4579,
    lng: -70.6636,
    focus: "Interdisciplinary data science and AI research, education, public-interest applications and collaboration",
    notes: "Official FCFM initiative connecting University of Chile researchers across data and AI. Its site publishes Beauchef 851 as the initiative's location.",
    sourceName: "IDIA - Universidad de Chile",
    sourceUrl: "https://idia.uchile.cl/"
  },
  {
    id: "cl-wic-uchile",
    name: "WIC - Web Intelligence Centre",
    organization: "Universidad de Chile",
    category: "Universidade",
    city: "Santiago",
    region: "Region Metropolitana",
    country: "Chile",
    address: "Domeyko 2367",
    lat: -33.454,
    lng: -70.6691,
    focus: "Applied AI, data science, NLP, computer vision, big-data analytics and digital health",
    notes: "University of Chile applied R&D center that develops and transfers AI and data solutions, with a published street address and explicit AI services and expertise.",
    sourceName: "WIC - Universidad de Chile",
    sourceUrl: "https://wic.uchile.cl/home/about-us/"
  },
  {
    id: "co-cinfonia-uniandes",
    name: "CINFONIA - Centro de Investigacion y Formacion en IA",
    organization: "Universidad de los Andes",
    category: "Universidade",
    city: "Bogota",
    region: "Bogota D.C.",
    country: "Colombia",
    address: "Cra. 1 E No. 19A-40, Edificio Mario Laserna",
    lat: 4.6012,
    lng: -74.0662,
    focus: "Responsible AI, fundamental research, computer vision, health, sustainable development and AI education",
    notes: "Official Uniandes academic AI center combining research, education and ethical principles. Its site publishes the Mario Laserna building address.",
    sourceName: "CINFONIA - Uniandes",
    sourceUrl: "https://cinfonia.uniandes.edu.co/"
  },
  {
    id: "co-gidia-unal",
    name: "GIDIA - Grupo de Investigacion y Desarrollo en Inteligencia Artificial",
    organization: "Universidad Nacional de Colombia - Facultad de Minas",
    category: "Universidade",
    city: "Medellin",
    region: "Antioquia",
    country: "Colombia",
    address: "Carrera 80 No. 65-223, Campus Robledo",
    lat: 6.2749,
    lng: -75.5902,
    focus: "Machine learning, multi-agent systems, computer vision, recommender systems, ontologies and intelligent environments",
    notes: "Official UNAL research group, rated A1 by Colombia's science system in 2024, with a broad published AI research agenda and campus address.",
    sourceName: "Facultad de Minas - UNAL",
    sourceUrl: "https://minas.medellin.unal.edu.co/vicedecanaturadeinvestigacion/index.php/investigacion-fm/grupos-de-investigacion/21-ciencias-de-la-computacion-y-de-la-decision/58-inteligencia-artificial-gidia"
  },
  {
    id: "ec-labia-utpl",
    name: "LabIA - Laboratorio de Inteligencia Artificial",
    organization: "Universidad Tecnica Particular de Loja",
    category: "Universidade",
    city: "Loja",
    region: "Loja",
    country: "Ecuador",
    address: "San Cayetano Alto, Calle Paris s/n",
    lat: -3.9867,
    lng: -79.1988,
    focus: "Affective computing, computer vision, NLP, text mining, human-computer interaction and machine learning",
    notes: "Official interdisciplinary UTPL laboratory for AI research and student experimentation. Marker uses the university's published San Cayetano Alto campus address.",
    sourceName: "UTPL Investigacion",
    sourceUrl: "https://investigacion.utpl.edu.ec/laboratorio/laboratorio-de-inteligencia-artificial"
  },
  {
    id: "py-goblab-mitic",
    name: "GOBLAB - Laboratorio de Innovacion del Gobierno",
    organization: "MITIC Paraguay",
    category: "Governo",
    city: "Asuncion",
    region: "Capital",
    country: "Paraguay",
    address: "Complejo Santos E2, Gral. Santos 1170 c/ Concordia",
    lat: -25.291,
    lng: -57.605,
    focus: "Applied research and smart public services using AI, blockchain, IoT, quantum computing, big data and open data",
    notes: "Official MITIC scope explicitly assigns AI research and AI-enabled public services to GOBLAB. No separate public lab address is listed, so the marker uses MITIC's official headquarters.",
    sourceName: "MITIC - official GOBLAB scope",
    sourceUrl: "https://mitic.gov.py/eoj0cad9uplo/2025/07/PAAD_C1_TdR_APOYO-LAB-GOB-PY_para-NOB_Fir.pdf"
  },
  {
    id: "pe-ia-pucp",
    name: "IA-PUCP - Grupo de Inteligencia Artificial",
    organization: "Pontificia Universidad Catolica del Peru",
    category: "Universidade",
    city: "Lima",
    region: "Lima",
    country: "Peru",
    address: "Av. Universitaria 1801, Pabellon O Lab 504, San Miguel",
    lat: -12.0694,
    lng: -77.0796,
    focus: "AI, machine learning, computer vision, NLP, bioinformatics, pattern recognition and indigenous-language translation",
    notes: "Official PUCP scientific research group recognized by CONCYTEC, with laboratories and offices identified on its institutional page.",
    sourceName: "IA-PUCP",
    sourceUrl: "https://ia.inf.pucp.edu.pe/about"
  },
  {
    id: "pe-up-ai-decisions",
    name: "Laboratorio de IA para la Toma de Decisiones",
    organization: "Universidad del Pacifico",
    category: "Universidade",
    city: "Lima",
    region: "Lima",
    country: "Peru",
    address: "Av. Salaverry 2020, Jesus Maria",
    lat: -12.0832,
    lng: -77.0482,
    focus: "Machine learning, computational intelligence, evolutionary computing, optimization and decision support",
    notes: "Official multidisciplinary R&D laboratory applying AI to decisions in public and private organizations. The lab page does not list a room, so the marker uses the university's official campus address.",
    sourceName: "Universidad del Pacifico",
    sourceUrl: "https://ia.up.edu.pe/nosotros/"
  },
  {
    id: "pe-labiar-uni",
    name: "LABIAR - Laboratorio de Inteligencia Artificial y Robotica",
    organization: "Universidad Nacional de Ingenieria",
    category: "Universidade",
    city: "Lima",
    region: "Lima",
    country: "Peru",
    address: "Av. Tupac Amaru 210, Rimac",
    lat: -12.0238,
    lng: -77.0483,
    focus: "AI, robotics, NLP, computer vision, optimization, IoT and human-computer interaction",
    notes: "Official FIIS-UNI laboratory for research, development, consulting and advanced training. Marker uses UNI's published main-campus address.",
    sourceName: "FIIS - UNI",
    sourceUrl: "https://www.fiis.uni.edu.pe/laboratorios/labiar"
  },
  {
    id: "pe-ia-upch",
    name: "IA-UPCH - Laboratorio de Inteligencia Artificial",
    organization: "Universidad Peruana Cayetano Heredia",
    category: "Universidade",
    city: "Lima",
    region: "Lima",
    country: "Peru",
    address: "Av. Honorio Delgado 430, Urb. Ingenieria",
    lat: -12.0236,
    lng: -77.056,
    focus: "High-performance AI and MLOps for health, foundation models, LLMs, computer vision and multimodal learning",
    notes: "Official Faculty of Sciences and Engineering laboratory focused on AI research, training and health applications; the faculty page publishes this address.",
    sourceName: "UPCH - Facultad de Ciencias e Ingenieria",
    sourceUrl: "https://ciencias.cayetano.edu.pe/noticias/laboratorio-de-inteligencia-artificial/"
  },
  {
    id: "pe-lab-iatd-unmsm",
    name: "LAB-IATD - Laboratorio de IA y Transformacion Digital",
    organization: "Universidad Nacional Mayor de San Marcos",
    category: "Universidade",
    city: "Lima",
    region: "Lima",
    country: "Peru",
    address: "Calle German Amezaga 375, Ciudad Universitaria",
    lat: -12.0566,
    lng: -77.0845,
    focus: "Generative AI, big-data analytics, process automation, digital services, AI governance and organizational transformation",
    notes: "Official UNMSM innovation hub with a coordinator, research lines and registered projects. The page lists an internal research unit; the marker uses the published university address.",
    sourceName: "VRIP - UNMSM",
    sourceUrl: "https://vrip.unmsm.edu.pe/grupo_investigacion/lab-iatd/"
  },
  {
    id: "uy-cicada-udelar",
    name: "CICADA - Centro de Ciencia de Datos y Aprendizaje Automatico",
    organization: "Universidad de la Republica",
    category: "Consorcio",
    city: "Montevideo",
    region: "Montevideo",
    country: "Uruguay",
    address: "Jose Enrique Rodo 1843",
    lat: -34.9033,
    lng: -56.1774,
    focus: "Interdisciplinary machine learning, responsible AI, ecology, genomics, neuroscience, health and education",
    notes: "Official Udelar interdisciplinary center funded again for 2026-2030 and spanning nine university services. Marker uses the contact address published by Espacio Interdisciplinario.",
    sourceName: "Espacio Interdisciplinario - Udelar",
    sourceUrl: "https://www.ei.udelar.edu.uy/grupos-financiados/sigla-acronimo/centro-ciencia-datos"
  },
  {
    id: "uy-utec-ai-applications",
    name: "Grupo de Investigacion en Aplicaciones de Inteligencia Artificial",
    organization: "Universidad Tecnologica del Uruguay",
    category: "Universidade",
    city: "Durazno",
    region: "Durazno",
    country: "Uruguay",
    address: "Francisco Antonio Maciel s/n esq. Luis Morquio",
    lat: -33.38711,
    lng: -56.5153,
    focus: "Machine learning, deep learning, computer vision, pattern recognition, environmental monitoring and decision support",
    notes: "Official UTEC research group with funded applied-AI projects. Its members are distributed; the marker uses the official Durazno campus associated with its contact researcher rather than implying a separate lab building.",
    sourceName: "UTEC Investigacion",
    sourceUrl: "https://utec.edu.uy/es/investigacion/gruposde-investigacion/grupo-de-investigacion-en-aplicaciones-de-inteligencia-artificial/"
  },
  {
    id: "br-sc-giaa-ufsc",
    name: "GIAA - Grupo de Inteligencia Artificial e Algoritmos",
    organization: "Departamento de Informatica e Estatistica / UFSC",
    category: "Universidade",
    city: "Florianopolis",
    region: "Santa Catarina",
    country: "Brazil",
    address: "Centro Tecnologico, Campus Universitario, salas 501 e 502, Trindade",
    lat: -27.60059,
    lng: -48.51874,
    focus: "Knowledge representation, multi-agent systems, optimization, pattern recognition, computer vision and quantum computing",
    notes: "Official UFSC group conducting basic and applied AI research. Its page publishes the department, rooms, contact details and research lines, so both the initiative and marker are directly confirmed.",
    sourceName: "GIAA - UFSC",
    sourceUrl: "https://giaa.ufsc.br/"
  },
  {
    id: "br-sc-radaria-ufsc",
    name: "RadarIA - Observatorio de IA no Ensino Superior",
    organization: "INPEAU / Universidade Federal de Santa Catarina",
    category: "Universidade",
    city: "Florianopolis",
    region: "Santa Catarina",
    country: "Brazil",
    address: "Campus Universitario da Trindade, INPEAU-UFSC",
    lat: -27.6017,
    lng: -48.5208,
    focus: "AI adoption and governance in higher education, institutional policy, ethics, mapping and knowledge dissemination",
    notes: "Permanent UFSC observatory integrating research, extension and innovation around AI in higher education. No separate room is published; the marker therefore represents its INPEAU host on the UFSC campus.",
    sourceName: "RadarIA - UFSC",
    sourceUrl: "https://radaria.ufsc.br/sobre/"
  },
  {
    id: "br-sc-labtec-ufsc",
    name: "LabTeC - Laboratorio de Tecnologias Computacionais",
    organization: "Departamento de Computacao / UFSC Ararangua",
    category: "Universidade",
    city: "Ararangua",
    region: "Santa Catarina",
    country: "Brazil",
    address: "Rodovia Governador Jorge Lacerda, 3201, Jardim das Avenidas",
    lat: -28.9509,
    lng: -49.46757,
    focus: "AI and software engineering for education, games, mobile devices and robotics kits",
    notes: "Official UFSC research laboratory with named coordinators and explicit AI research. The department page publishes the campus address but not a room, so the marker represents the Jardim das Avenidas campus.",
    sourceName: "Departamento de Computacao - UFSC",
    sourceUrl: "https://dec.ufsc.br/laboratorios/"
  },
  {
    id: "br-sc-univali-applied-computing-lab",
    name: "Laboratorio de Pesquisa em Computacao Aplicada",
    organization: "Mestrado em Computacao Aplicada / Univali",
    category: "Universidade",
    city: "Sao Jose",
    region: "Santa Catarina",
    country: "Brazil",
    address: "Campus Kobrasol, BR-101, km 207, MundoCar Shopping Kobrasol",
    lat: -27.59789,
    lng: -48.61982,
    focus: "Applied AI, distributed systems, cybersecurity, software engineering, HPC and big-data analysis",
    notes: "Official Univali laboratory for advanced scientific and technological research, with an identified coordinator, equipment and AI techniques. The page specifies Campus Kobrasol; the marker uses the campus position because no room is published.",
    sourceName: "Univali",
    sourceUrl: "https://portal.univali.br/laboratorios/laboratorio-de-pesquisa-em-computacao-aplicada"
  },
  {
    id: "br-sc-coca-udesc",
    name: "COCA - Grupo de Computacao Cognitiva Aplicada",
    organization: "Departamento de Ciencia da Computacao / UDESC Joinville",
    category: "Universidade",
    city: "Joinville",
    region: "Santa Catarina",
    country: "Brazil",
    ...
    lat: -26.25334,
    lng: -48.85516,
    focus: "Machine learning, generative AI, computational intelligence, complex problems, image processing and computer vision",
    notes: "Current UDESC research-group catalog identifies the leader and AI research lines and links the certified CNPq record. No separate room is published; the marker represents the official CCT Joinville campus.",
    sourceName: "UDESC Joinville",
    sourceUrl: "https://www.udesc.br/cct/pesquisa/linhas"
  },
  {
    id: "br-sc-ldtt-furb",
    name: "LDTT - Laboratorio de Desenvolvimento e Transferencia de Tecnologia",
    organization: "Universidade Regional de Blumenau",
    category: "Universidade",
    city: "Blumenau",
    region: "Santa Catarina",
    country: "Brazil",
    address: "Rua Antonio da Veiga, 900, Campus I, sala S-223",
    lat: -26.9053,
    lng: -49.0798,
    focus: "Applied AI, machine learning, emotion recognition, computer vision, industrial systems and technology transfer",
    notes: "Official FURB laboratory combining research, teaching and community extension. Its page identifies current AI research expertise and publishes the Campus I room; the coordinates represent that campus building.",
    sourceName: "LDTT - FURB",
    sourceUrl: "https://ldtt.furb.br/"
  },
  {
    id: "br-sc-agrotechlab-ifsc",
    name: "AgroTechLab - Laboratorio de Tecnologias para o Agronegocio",
    organization: "Instituto Federal de Santa Catarina",
    category: "Instituto",
    city: "Lages",
    region: "Santa Catarina",
    country: "Brazil",
    address: "Orion Parque Tecnologico, Rua Heitor Vila Lobos, 525, sala 312",
    lat: -27.7931,
    lng: -50.3098,
    focus: "Applied AI, IoT, embedded systems, LPWAN, automation and web and mobile systems for agribusiness",
    notes: "Active IFSC multidisciplinary applied-research laboratory with named projects and an explicit AI technology line. The official page publishes its exact room in Orion Parque Tecnologico.",
    sourceName: "AgroTechLab - IFSC",
    sourceUrl: "https://agrotechlab.lages.ifsc.edu.br/"
  },
  {
    id: "br-sc-gaia-ifsc",
    name: "GAIA - Grupo de Pesquisa em Aplicacoes em Inteligencia Artificial",
    organization: "Instituto Federal de Santa Catarina - Campus Cacador",
    category: "Instituto",
    city: "Cacador",
    region: "Santa Catarina",
    country: "Brazil",
    address: "Avenida Fahdo Thome, 3000, Champagnat",
    lat: -26.77973,
    lng: -51.03931,
    focus: "Applied AI for health, agribusiness, industry, services and education, including ML, agents, ethics and governance",
    notes: "Certified IFSC research group active since 2024, with an institutional project record and 2025 activities. No dedicated room is published; the marker uses the official Campus Cacador position, independently confirmed by the IBGE geodetic station on campus.",
    sourceName: "Integra IFSC",
    sourceUrl: "https://integra.ifsc.edu.br/ecossistema/pessoas/paulo-roberto-cordova"
  },
  {
    id: "br-sc-labgaia-unesc",
    name: "LabGaIA - Laboratorio de IA e Analytics Educacional",
    organization: "Universidade do Extremo Sul Catarinense",
    category: "Universidade",
    city: "Criciuma",
    region: "Santa Catarina",
    country: "Brazil",
    address: "Avenida Universitaria, 1105, Bairro Universitario",
    lat: -28.68697,
    lng: -49.36981,
    focus: "AI and learning analytics, applied education research and computing infrastructure for AI projects",
    notes: "Current official UNESC pages identify LabGaIA as active infrastructure supporting AI education, after its multi-user research-lab structuring project appeared in the university's 2025 selection. No room is published; the marker represents the official Criciuma campus.",
    sourceName: "UNESC",
    sourceUrl: "https://www.unesc.net/inteligencia-artificial-semipresencial"
  }
];
